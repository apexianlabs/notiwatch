...
const COLOR = '#ea580c'
const PRODUCT_NAME = 'NotiWatch'
const PRODUCT_INITIAL = 'N'
const COOKIE = 'not'
const ITEM_NAME = 'Monitors'
...
const Logo = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="nw1" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="#fb923c"/>
        <stop offset="100%" stopColor="#c2410c"/>
      </linearGradient>
    </defs>
    <path d="M50 12 C50 12 48 12 48 14 C37 16 28 26 28 40 L28 62 L20 70 L80 70 L72 62 L72 40 C72 26 63 16 52 14 C52 12 50 12 50 12Z" fill="url(#nw1)"/>
    <path d="M43 70 Q43 78 50 78 Q57 78 57 70Z" fill="url(#nw1)"/>
  ...
  const Sidebar = () => (
    <div style={{width:220,background:'linear-gradient(180deg,#0a0f2e 0%,#0f172a 100%)',display:'flex',flexDirection:'column',padding:'20px 12px',height:'100vh',position:'sticky',top:0,flexShrink:0,overflowX:'hidden'}}>
      ...
      <div style={{marginTop:'auto',borderTop:'1px solid rgba(255,255,255,0.06)',paddingTop:14}}>
        ...
        <button onClick={() => { document.cookie='not_token=;max-age=0'; document.cookie='not_user=;max-age=0'; router.push('/login') }}
